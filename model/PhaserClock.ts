...
import { TimerEvent, TimerEventConfig } from './PhaserTimerEvent.js';
import { Remove } from './PhaserArrayRemove.js';
...
export class Clock {
     ...
     * @since 3.0.0
     */
    public _pendingInsertion: TimerEvent[] = [];
     ...
     * @since 3.0.0
     */
    public _pendingRemoval: TimerEvent[] = [];
     ...
     */
    addEvent(config: TimerEvent | TimerEventConfig) {
        var event;
     ...
     * @return {this} - This Clock instance.
     */
    removeEvent(events: TimerEvent | TimerEvent[]) {
